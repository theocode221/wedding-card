...
export const PORTFOLIO_ITEMS: readonly PortfolioItem[] = [
  ...
  {
    id: "malay-classic-frame",
    title: "Malay Classic (Bingkai)",
    description: "Tema Melayu klasik pada shell animasi bingkai — RSVP & aturcara.",
    path: "/jemputan-frame-malay-classic",
    category: "jemputan",
    previewGradient: "linear-gradient(155deg, #f0e2c0 0%, #faf6ef 42%, #1a1510 100%)",
    showOnDemo: false,
    tags: ["Classic", "Animasi", "RSVP"],
  },
  {
    id: "paan",
